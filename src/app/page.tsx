        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          {[
            ...
            <Link
              ...
              className="border border-gray-200 hover:border-black transition-colors duration-200 py-4 sm:py-6 px-3 sm:px-4 text-xs sm:text-sm tracking-widest uppercase text-center"
            >
              {cat.name}
            </Link>
          ))}
